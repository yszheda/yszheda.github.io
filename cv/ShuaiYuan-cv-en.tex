...
\begin{itemize}
    \item Senior Software Engineer, Dorabot Company, 2018/10--current.
        \begin{itemize}
            \item I'm mainly working on collision detection and performance optimization related to robot motion planning. My contributions include, but are not limited to:
                \begin{itemize}
