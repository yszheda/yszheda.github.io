...
\begin{itemize}
  ...
  \end{itemize}
  \item GPU-RSCode: a GPGPU approach to accelerating Reed-Solomon codes for fault-Tolerance in RAID-like system, 2012/12--2013/3.
	\begin{itemize}
	  \item Written in CUDA C. Source code and documents are available under GPLv3: \\ \url{https://github.com/yszheda/GPU-RSCode}
	  \item Under our experimental settings, we have achieved a maximum speed-up of approximately 90 over the performance of traditional CPU-based Reed-Solomon Codes.
	\end{itemize}
