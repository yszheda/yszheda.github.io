...
\begin{itemize}
    \item Software Engineer, Dorabot, 2018/10--current.
        \begin{itemize}
          \item Performance optimization on collision detection for arm motion planning. We have achieved 6x speedup.
                \begin{itemize}
                    \item Implement broad phase collision detection to reduce pair-to-pair collision detection time
                    \item Use SSE and AVX to accelerate OBB overlap checking. We have archived 1.3-1.6x speedup.
                \end{itemize}
            \item Implement collision detection feature for grasp planning
            \item Implement Seidel solver to improve the performance of TOPP-RA parameterizer.
        \end{itemize}
        ...
        \begin{itemize}
            \item My contributions in Glass Flaw Detecting Project:
                \begin{itemize}
                    ...
                    \item Implement GPU version of car-glass flaw detecting. We have archived 5-6s for detecting flaws for each car glass.
                    \item Accelerating Connected Component Labeling using CUDA.
            ...
            \item My contributions in Mobile Face Detecting Project:
                \begin{itemize}
                    \item Optimize YUV/RGA conversion, rotation etc. in RenderScript.
                \end{itemize}
            \item Now I am working on improving the performance of our Dynamic Face Recognition and Tracking System.
        \end{itemize}
...
% Assembly, OCaml(partial), ocamlyacc, ocamllex, etc.
    \item Framework/API: \textbf{CUDA}, \textbf{MPI}, \textbf{cocos2d-x}, \textbf{quick-cocos2d-x}, \textbf{OpenResty}, etc.
