...
\begin{itemize}
    \item Mobile game developer in Xinyoudi Studio, Leqee Company, 2014/7--current.
        \begin{itemize}
            ...
            \item Get my hands dirty on frontend development using \href{http://cocos2d-x.org/}{\tt cocos2d-x} and \href{https://github.com/dualface/v3quick}{\tt quick-cocos2d-x}, also have backend development experience using \href{http://openresty.org/}{\tt OpenResty}.
            \item My main contributions include:
                \begin{itemize}
                    ...
                    \item Multiple modules including battle.
...
\begin{itemize}
    \item GPU-RSCode: a GPGPU approach to accelerating Reed-Solomon codes for fault-tolerance in RAID-like system, 2012/12--2014/5.
        \begin{itemize}
            ...
            \item We present an optimized GPU implementation of Reed-Solomon Codes, which can achieve a speedup of 14.71 over the current best CPU implementation \href{http://jerasure.org/}{\tt Jerasure}.
        \end{itemize}
...
\begin{itemize}
    ...
    \item \href{https://github.com/openresty/openresty-devel-utils}{\tt openresty-devel-utils} (a simple patch \href{https://github.com/openresty/openresty-devel-utils/pull/9}{\tt PR\#9}, accepted).
...
% \item Language: English, Native Mandarin
    \item Programming Language: C, C++, Lua, Verilog HDL, script(mainly bash), etc.
